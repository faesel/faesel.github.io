...
const AboutPage = () => {
  return (
    <Layout>
      ...
      <blockquote>Its time to take off these academic shekels and venture into the working world</blockquote>
      <p>As soon as I wrapped up university in 2008 the <a rel="nofollow" target="_blank" href="https://en.wikipedia.org/wiki/Financial_crisis_of_2007%E2%80%932008">financial crisis</a> happened , which made finding a job challenging. It was at this point that I pivoted from games technology which only really had a few companies in the UK (this was before mobile games exploded), to web applications and have been loving it since!</p>
      ...
      <p>You can read more about my career history on my <a rel="nofollow" target="_blank" href="https://www.linkedin.com/in/faesel-saeed-%F0%9F%92%BB-a97b1614/ page">Linked In profile</a></p>
